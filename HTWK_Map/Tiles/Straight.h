...
#ifndef AADC_USER_STRAIGHT_H
#define AADC_USER_STRAIGHT_H

#include "../MapElement.h"

#define STRAIGHT_TILE_SIZE 1

class Straight : public MapElement {
public:
    Straight(int id, MapTileType tileTypeId, const HTWKPoint &positon, Orientation::MapTile orient)
            : MapElement(id, tileTypeId, positon, orient) {

        tileSize = STRAIGHT_TILE_SIZE;
    ...
    void generateTileExitPoints() override {
        ...
        switch (orient) {
            case Orientation::MapTile::NORTH:
                ...
                tileExitPoint1.setYval(tileEntryPoints[1]->y() - STRAIGHT_TILE_SIZE);
                tileExitPoint2.setXval(tileEntryPoints[0]->x());
                tileExitPoint2.setYval(tileEntryPoints[0]->y() + STRAIGHT_TILE_SIZE);
                break;
            case Orientation::MapTile::WEST:
                tileExitPoint1.setXval(tileEntryPoints[1]->x() + STRAIGHT_TILE_SIZE);
                tileExitPoint1.setYval(tileEntryPoints[1]->y());
                tileExitPoint2.setXval(tileEntryPoints[0]->x() - STRAIGHT_TILE_SIZE);

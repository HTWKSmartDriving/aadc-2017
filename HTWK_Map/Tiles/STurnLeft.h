...
#ifndef AADC_USER_STURNLEFT_H
#define AADC_USER_STURNLEFT_H

#define STURN_TILE_SIZE 3
#define STURN_CIRCLE_CENTER_OFFSET 0.86993

class STurnLeft : public MapElement {
public:
    STurnLeft(int id, MapTileType tileTypeId, const HTWKPoint &positon, Orientation::MapTile orient)
        ...
        switch (orient) {
            case Orientation::MapTile::NORTH:
                tileEntryPoint1.setXval(
                        ...
                        MIDDLE_LINE_WIDTH + TRACK_WIDTH / 2  + (tileSize-1));
